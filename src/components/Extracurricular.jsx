        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-10">
                    {/* IEEE Activities */}
                    <motion.div
                        className="bg-white dark:bg-gray-800 border-l-4 border-blue-600 p-6 rounded-xl shadow-md hover:shadow-lg transition"
                    ...
                    >
                        ...
                        <div className="text-gray-800 dark:text-white space-y-4">
                            <div>
                                ...
                                <ul className="list-disc list-inside ml-5 text-gray-700 dark:text-gray-300 text-sm">
